<div id="reviews" class="py-10 lg:py-20 bg-white">
    <div class="container space-y-16">
        <!-- Header Section -->
        <div class="text-left">
            <h2 class="text-3xl font-bold text-gray-900 tracking-tighter">{{ __('Müşterilerimiz iDentik Hakkında Ne Düşünüyor') }}</h2>
            <p class="text-xl font-normal text-text tracking-tighter">
                {{ __('Sizlere en iyi hizmeti sağlamak için elimizden gelenin en iyisini yapıyoruz.') }}
            </p>
        </div>
        ...
        <div class="grid lg:grid-cols-2 gap-6">
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                <div class="flex items-center justify-between">
                    <div class="flex items-center space-x-4">
                        <div class="text-3xl font-bold text-gray-900" data-trustpilot-rating>{{ $trustpilotStats['averageRating'] ?: '3.0' }}</div>
                        <div class="flex items-center space-x-1">
                            ...
                            @for ($i = 1; $i <= 5; $i++)
                                @if ($i <= $trustpilotFullStars)
                                    <!-- Full star -->
                                    <svg class="w-5 h-5" fill="orange" viewBox="0 0 20 20">
                                        <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z"/>
                                    </svg>
                                @elseif ($i == $trustpilotFullStars + 1 && $trustpilotHasPartialStar)
                                    <!-- Partial star with precise percentage -->
                                    <svg class="w-5 h-5" viewBox="0 0 20 20">
                                        <defs>
                                            <linearGradient id="partial-star-trustpilot-{{ $i }}">
                                                <stop offset="{{ $trustpilotPartialPercentage }}%" stop-color="orange"/>
                                                <stop offset="{{ $trustpilotPartialPercentage }}%" stop-color="#d1d5dc"/>
                                            </linearGradient>
                                        </defs>
                                        <path fill="url(#partial-star-trustpilot-{{ $i }})" d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z"/>
                                    </svg>
                                @else
                                    <!-- Empty star -->
                    ...
                    <div class="flex items-center justify-end">
                        <x-view-all-gray route="https://www.trustpilot.com/review/identik.com.tr" />
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                <div class="flex items-center justify-between">
                    <div class="flex items-center space-x-4">
                        <div class="text-3xl font-bold text-gray-900" data-google-rating>{{ $googleStats['averageRating'] ?: '4.4' }}</div>
                        <div class="flex items-center space-x-1">
                            @php
                            ...
                            @for ($i = 1; $i <= 5; $i++)
                                ...
                                @elseif ($i == $fullStars + 1 && $hasPartialStar)
                                    <!-- Partial star with precise percentage -->
                                    <svg class="w-5 h-5" viewBox="0 0 20 20">
                                        <defs>
                                            <linearGradient id="partial-star-google-{{ $i }}">
                                                <stop offset="{{ $partialPercentage }}%" stop-color="orange"/>
                                                <stop offset="{{ $partialPercentage }}%" stop-color="#d1d5dc"/>
                                            </linearGradient>
                                        </defs>
                                        <path fill="url(#partial-star-google-{{ $i }})" d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z"/>
                                    </svg>
                                @else
                                    <!-- Empty star -->
                                    <svg class="w-5 h-5" fill="#d1d5dc" viewBox="0 0 20 20">
